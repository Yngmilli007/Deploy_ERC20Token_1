...
async function main() {
    const replace_contractAddress = "0xF8d7b47d7E2b3cEdEcfbe40c222659A5860980bE";
    const [signer] = await hre.ethers.getSigners();
    const replace_contractFactory = await hre.ethers.getContractFactory("YngToken");
    const contract = replace_contractFactory.attach(replace_contractAddress);
  
    const replace_functionName = "mint";
    const replace_functionArgs = ["0x19ECb8C7F1e5d4A2716Cc7c492BDDf98a71cd773","100000000000000000000"]; // 100 tokens with 18 decimal places
